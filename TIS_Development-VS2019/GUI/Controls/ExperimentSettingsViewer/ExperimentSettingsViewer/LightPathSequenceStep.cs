namespace ExperimentSettingsViewer
{
    ...
    public class LightPathSequenceStep : INotifyPropertyChanged
    {
        ...
        public LightPathSequenceStep(string str, XmlNode lightPathSequenceStepNode, int lineNumber)
        {
            _name = str;
        ...
        public void GetLightPath(ref int GGEnable, ref int GREnable, ref int CamEnable)
        {
