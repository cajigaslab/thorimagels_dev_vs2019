namespace HardwareSetupDll.View
{
    ...
    public partial class ApplicationSettings : Window
    {
        ...
        private void AppSettings_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                //Change the height of the application settings viewer window for tablet mode
                xmlViewer.Height = 400;
        ...
        private void UpdateDocument()
        {
            ...
            try
            {
                ...
                xmlDoc.Load(ResourceManagerCS.GetApplicationSettingsFileString());
