namespace HelloWorldDll
{
    ...
    public class HelloWorld : IModule
    {
        ...
        public HelloWorld(IUnityContainer container, IRegionManager regionManager,IEventAggregator eventAggregator)
        {
            Container = container;
        ...
        public void CommandEventHandler(Command command)
        {
            ...
            this.SettingsRegion.Add(this.MainWindowView, "HelloWorld", true);
