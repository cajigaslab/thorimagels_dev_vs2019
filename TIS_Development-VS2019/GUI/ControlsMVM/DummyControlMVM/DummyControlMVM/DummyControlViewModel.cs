namespace DummyControl.ViewModel
{
    using System;
    ...
    public class DummyControlViewModel : ThorSharedTypes.VMBase, ThorSharedTypes.IMVM
    {
        #region Fields

     
        private readonly DummyControlModel _DummyControlModel;
        ...
        public DummyControlViewModel()
        {
            this._DummyControlModel = new DummyControlModel();
        }
        ...
        public PropertyInfo GetPropertyInfo(string propertyName)
        {
            ...
            {
                myPropInfo = typeof(DummyControlViewModel).GetProperty(propertyName);
                if (null != myPropInfo)
                {
