...
public:
	static const char * const ROOT_TAG;
	 ...
	 enum {NUM_OBJECTIVE_ATTRIBUTES = 13};
	...
	long GetMagInfoFromMagVal(double mag, string &name, long &position, double &numAper, double &afScanStart,double &afFocusOffset, double &afAdaptiveOffset,long &beamExpPos,long &beamExpWavelength,long &beamExpPos2, long &beamExpWavelength2,long &turretPosition,long &zAxisToEscape, double &zAxisEscapeDistance);///magnification details from magnification value
	long GetMagInfoFromPosition(long position,  string &name, double &mag, double &numAper, double &afScanStart,double &afFocusOffset, double &afAdaptiveOffset,long &beamExpPos,long &beamExpWavelength,long &beamExpPos2, long &beamExpWavelength2,long &turretPosition,long &zAxisToEscape, double &zAxisEscapeDistance);//magnification details from position index
	long GetMagInfoFromName(string name, double &mag, long &position, double &numAper, double &afScanStart,double &afFocusOffset, double &afAdaptiveOffset,long &beamExpPos,long &beamExpWavelength,long &beamExpPos2, long &beamExpWavelength2,long &turretPosition,long &zAxisToEscape, double &zAxisEscapeDistance);
