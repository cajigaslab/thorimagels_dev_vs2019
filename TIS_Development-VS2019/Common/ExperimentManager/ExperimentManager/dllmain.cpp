...
DllExportExpManger GetSubImages(vector<IExperiment::SubImage>& subImages, long cameraType, long lsmType, long mROIenabled)
{
	...
	ret = exp->GetSubImages(subImages, cameraType, lsmType, mROIenabled);
