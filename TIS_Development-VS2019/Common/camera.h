...
public:
	...
	enum LightPathType
	{
		LIGHTPATHTYPE_FIRT = 0,
		LIGHTPATHTYPE_GALVO_RESONANCE = 0,
		LIGHTPATHTYPE_GALVO_GALVO,
		LIGHTPATHTYPE_RESONANCE_GALVO_GALVO,
		LIGHTPATHTYPE_CCD,
		LIGHTPATHTYPE_LAST
	};
	...
	enum PowerRampMode
	{
		FIRST_POWER_RAMP_MODE = 0,
		POWER_RAMP_MODE_CONTINUOUS = 0,
		POWER_RAMP_MODE_STAIRCASE = 1,
		LAST_POWER_RAMP_MODE
	};
	...
	enum Params
	{
		...
		PARAM_GAIN_DECIBELS,///<When camera is a Discrete Gain camera, this is the real gain and PARAM_GAIN is an index into a set of gains
		PARAM_GAIN_DISCRETE_DECIBELS_VALUES,//<Readonly list of all the real Discrete gains
		PARAM_GAIN_TYPE,
