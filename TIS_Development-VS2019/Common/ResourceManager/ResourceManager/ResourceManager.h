...
private:
	...
	static wstring _sequentialCacheDir;
...
public:
	...
	wstring GetSequentialCachePath();
	...
	wstring GetStartupFlag();

	wstring GetModality();
	long SetModality(wchar_t* modalityName);

	long ReloadDirectories();
	...
	long SetMyDocumentsThorImageFolderPath(wchar_t* folderPath);

	long SetStartupFlag(wchar_t* value);
