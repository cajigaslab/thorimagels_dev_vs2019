...
#pragma warning(pop)	
	...
	DECLARE_FUNCTION3(long, GetThorDAQGGWaveformParams, const wchar_t*, void*, bool)
	DECLARE_FUNCTION5(long, GetThorDAQGGWaveformParamsAndBufferWithStatus, SignalType, void*, long, uint64_t&, bool)
