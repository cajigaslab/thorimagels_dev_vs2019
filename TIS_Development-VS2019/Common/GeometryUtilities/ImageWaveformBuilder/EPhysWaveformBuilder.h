...
/// Polyline, ...
class EPhysWaveformBuilder : IWaveformBuilder
{
private:

	static bool _instanceFlag;
	static std::unique_ptr<EPhysWaveformBuilder> _single;
	...
	EPhysWaveformBuilder();

	void ResetWaveform();

public:
	~EPhysWaveformBuilder()	{ ResetWaveform(); _instanceFlag = false; }
	static EPhysWaveformBuilder* getInstance();
