...
public:
	...
	struct SequenceStep
	{
		...
		long DigSwitchesEnabled;
		long DigSwitchPos[8];
		long CameraChannel;
		long EpiTurretPosition;
		double Exposure;
		vector<Wavelength> Wavelength;
		vector<Pockels> Pockels;
		string EpiTurretPositionName;
	};
	...
	virtual long GetLSM(long& areaMode, double& areaAngle, long& scanMode, long& interleave, long& pixelX, long& pixelY, long& channel, long& fieldSize, long& offsetX, long& offsetY,
		...
		long& verticalFlip, long& horizontalFlip, double& crsFrequencyHz, long& timeBasedLineScan, long& timeBasedLSTimeMS, long& threePhotonEnable, long& numberOfPlanes, long& selectedImagingGG, long& selectedStimGG, double& pixelAspectRatioYScale) = 0;
	...
	virtual long GetSubImages(vector<SubImage>& subImages, long cameraType, long lsmType, long mROIEnabled) = 0;///mosaic details at each well
	...
	virtual long GetCaptureSequence(long& enable, long& sequentialType) = 0;
	...
	virtual long GetRemoteFocus(long& steps, long& startPlane, long& stepSize, long& captureMode, string& customSequence, long& isRemoteFocus) = 0;
	virtual long SetRemoteFocus(long steps, long startPlane, long stepSize, long captureMode, string customSequence, long isRemoteFocus) = 0;
