...
public:
	...
	virtual long GenerateHologram(float* pImg, int iteCount, float z) = 0;
	...
	virtual long CombineHologramFiles(const wchar_t * pathAndFilename1, const wchar_t * pathAndFilename2) = 0;
...
class HoloGenDLL : public PDLL, public IHologramGenerator
{
	...
	DECLARE_FUNCTION2(long, CombineHologramFiles, const wchar_t *, const wchar_t *)
