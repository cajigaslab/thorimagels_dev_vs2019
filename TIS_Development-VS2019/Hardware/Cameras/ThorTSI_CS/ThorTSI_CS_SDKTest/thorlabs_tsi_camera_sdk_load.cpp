#include "..\ThorTSI_CS\inc\thorlabs_tsi_camera_sdk.h"
...
TL_CAMERA_GET_USB_BUS_SPEED tl_camera_get_usb_bus_speed;
TL_CAMERA_GET_DATA_RATE_SUPPORTED tl_camera_get_data_rate_supported;
...
TL_CAMERA_GET_PIXEL_WIDTH_UM tl_camera_get_pixel_width_um;
TL_CAMERA_GET_PIXEL_HEIGHT_UM tl_camera_get_pixel_height_um;
...
static void init_camera_sdk_function_pointers()
{
   ...
   tl_camera_get_usb_bus_speed = 0;
   tl_camera_get_data_rate_supported = 0;
   tl_camera_get_data_rate = 0;
   tl_camera_set_data_rate = 0;
   tl_camera_get_pixel_size_bytes = 0;
   tl_camera_get_pixel_width_um = 0;
   tl_camera_get_pixel_height_um = 0;
...
#ifdef _WIN32
   kernel_obj = LoadLibrary (L"thorlabs_unified_sdk_kernel.dll");
   if (!kernel_obj)
   {
...
// Linux specific stuff
   ...
   tl_camera_get_usb_bus_speed = (TL_CAMERA_GET_USB_BUS_SPEED)get_module_function(sdk_handle, "tl_camera_get_usb_bus_speed");
   if (!tl_camera_get_usb_bus_speed)
   {
      return (init_error_cleanup());
   }

   tl_camera_get_data_rate_supported = (TL_CAMERA_GET_DATA_RATE_SUPPORTED)get_module_function(sdk_handle, "tl_camera_get_data_rate_supported");
   if (!tl_camera_get_data_rate_supported)
   {
      return (init_error_cleanup());
   }
   ...
   tl_camera_get_pixel_width_um = (TL_CAMERA_GET_PIXEL_WIDTH_UM)get_module_function(sdk_handle, "tl_camera_get_pixel_width_um");
   if (!tl_camera_get_pixel_width_um)
   {
      return (init_error_cleanup());
   }

   tl_camera_get_pixel_height_um = (TL_CAMERA_GET_PIXEL_HEIGHT_UM)get_module_function(sdk_handle, "tl_camera_get_pixel_height_um");
   if (!tl_camera_get_pixel_height_um)
   {
      return (init_error_cleanup());
   }
