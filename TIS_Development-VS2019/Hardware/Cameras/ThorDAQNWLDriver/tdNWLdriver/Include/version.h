...
#define VER_MAJOR_NUM               6
#define VER_MINOR_NUM               0
#define VER_SUBMINOR_NUM			0
#define VER_BUILD_NUM               0001
...
#define VER_PRODUCTNAME_STR         "NWL OEM PCI Express Core"
#define VER_INTERNALNAME_STR        "tdNWLdriver.sys"
#define VER_COMPANYNAME_STR         "Thorlabs (TSI), Inc."
#define VER_FILEDESCRIPTION_STR     "PCI-e DMA ThorDAQ SDK Driver"
