...
#define IMAGE_WIDTH_MIN			16
#define IMAGE_WIDTH_STEP		4

#define GAIN_MIN				1
#define GAIN_MAX				4

Camera3240M::Camera3240M(INT cameraId, const char* serialNo) : 
	DCxCamera(cameraId, serialNo)
{	
}

long Camera3240M::GetUniqueParamInfo(const long paramID, double &paramMin, double &paramMax, double &paramDefault)
{
	long ret = TRUE;
