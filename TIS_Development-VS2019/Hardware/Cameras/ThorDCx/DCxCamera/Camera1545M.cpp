...
Camera1545M::Camera1545M(INT cameraId, const char* serialNo) : 
	DCxCamera(cameraId, serialNo)
{	
}

long Camera1545M::GetUniqueParamInfo(const long paramID, double &paramMin, double &paramMax, double &paramDefault)
{
	long ret = TRUE;
