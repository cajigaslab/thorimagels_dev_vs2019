...
private:
	...
	long processPixelData(const UCHAR* data, const int dataOffset, const int dataSize, FlimBuffer*& buffer, int& pixelIndex, int numPixel);
	long processPhotonData(const UCHAR* data, const int dataOffset, const int dataSize, FlimBuffer*& buffer, int numPhoton);
