...
public:
	...
	//long coarseShift[MAX_CHANNEL_COUNT];
	//long fineShift[MAX_CHANNEL_COUNT];
	ImgAcqPty()
	{
		...
		//memset(this->coarseShift,0,MAX_CHANNEL_COUNT*sizeof(long));
		//memset(this->fineShift,0,MAX_CHANNEL_COUNT*sizeof(long));
	}
