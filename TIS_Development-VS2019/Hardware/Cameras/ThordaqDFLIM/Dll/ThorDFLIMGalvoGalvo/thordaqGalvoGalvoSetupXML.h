...
public:
	...
	long GetConfiguration(double &field2Theta, long &pockelsParkAtMinimum, long &pockelsDelayUS, long &acquisitionMode, double& maxAngularVelocityRadPerSec, double& maxAngularAccelerationRadPerSecSq);
