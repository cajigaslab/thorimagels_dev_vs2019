...
const char * const ThorGalvoGalvoXML::CONFIG_ATTR[NUM_CONFIG_ATTRIBUTES] = {"field2Theta","pockelsParkAtMinimum","pockelsDelayUS","acquisitionMode"};

long ThorGalvoGalvoXML::GetConfiguration(double &field2Theta, long &pockelsParkAtMinimum, long &pockelsDelayUS, long &acquisitionMode)
{	
