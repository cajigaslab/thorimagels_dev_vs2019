...
#define MIN_DMA_BUFFER_NUM		4
#define DEFAULT_DMA_BUFFER_NUM	8
...
#define FLYBACK_OFFSET 16 // used to make the waveform of the flyback smaller. For synchronization purposes
...
// This is the default,
#define DEFAULT_PIXEL_X          512
#define DEFAULT_PIXEL_Y          512
...
#define DWELL_TIME_STEP              0.2 // dFLIM prefers < 0.2 step 
...
#define MIN_DFLIM_ACQUISITION_MODE     0
#define MAX_DFLIM_ACQUISITION_MODE     1
#define DEFAULT_DFLIM_AQUISITION_MODE  0

#define MIN_DFLIM_COARSE_SHIFT		0
#define MAX_DFLIM_COARSE_SHIFT		31
#define DEFAULT_DFLIM_COARSE_SHIFT	0

#define MIN_DFLIM_FINE_SHIFT		-256
#define MAX_DFLIM_FINE_SHIFT		64
#define DEFAULT_DFLIM_FINE_SHIFT	0

#define NUM_DFLIM_CLOCKS			5
#define MIN_DFLIM_CLOCK_FREQ		5
#define MAX_DFLIM_CLOCK_FREQ		700
#define DEFAULT_DFLIM_CLOCK_FREQ	5

#define MIN_DFLIM_SYNC_DELAY		0
#define MAX_DFLIM_SYNC_DELAY		31
#define DEFAULT_DFLIM_SYNC_DELAY	0

#define MIN_DFLIM_RESYNC_DELAY		0
#define MAX_DFLIM_RESYNC_DELAY		32767
#define DEFAULT_DFLIM_RESYNC_DELAY	0
