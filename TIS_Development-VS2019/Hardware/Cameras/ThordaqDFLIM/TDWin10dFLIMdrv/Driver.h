...
//half second MSI
#define ACQ_SINGLE_CHANNEL_BUF_CAP  0xE000000 // 0xE00.0000 is 224MB  (was 0x0400.0000, 64MB)
...
typedef struct _DEVICE_EXTENSION  {
	...
	ULONG32							FrameSizeInPixels;
	USHORT							FrameRate;
	USHORT							FramesPerTransfer;
	USHORT							Channel;
	ULONG32                         DataBufferStartAddress;// image acq buffer offset
	ULONG32                         MAXframeLengthPerChan; // single channel acq buffer length
	ULONG32                         DDR3startAddressFor2ndPingPongBank;//bank 0/1 length
