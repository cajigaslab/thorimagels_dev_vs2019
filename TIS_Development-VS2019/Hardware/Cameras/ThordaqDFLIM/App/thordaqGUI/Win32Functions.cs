...
namespace NWLogic.DeviceLib
{
    ...
    public struct GLOBAL_IMAGE_CTRL_STRUCT
    {
        public ushort system_mode;
    ...
    public sealed class Win32
    {
        ...
        /// <param name="DmaInfo">Returned DMA Info from Board</param>
        /// <returns>Handle to open device or NULL</returns>
        [DllImport("thordaq.dll", EntryPoint = "ThordaqConnectToBoard")]
        ...
        /// <param name="board">Instance number (0 based)</param>
        /// <returns>Handle to open device or NULL</returns>
        [DllImport("thordaq.dll", EntryPoint = "ThordaqDisconnectFromBoard")]
        ...
        /// <returns>Status of the operation</returns>
        [DllImport("thordaq.dll", EntryPoint = "ThordaqGetBoardCfg")]
        ...
        /// <returns>Status of the operation</returns>
        [DllImport("thordaq.dll", EntryPoint = "ThordaqWriteReadRegister")]
        ...
        /// <param name="board">Board number</param>
        /// <returns>Status of the operation</returns>
        [DllImport("thordaq.dll", EntryPoint = "ThordaqStartAcquisition")]
        ...
        /// <returns>Status of the operation</returns>
        [DllImport("thordaq.dll", EntryPoint = "ThordaqSetPacketModeAddressable")]
        ...
        ///// <param name="board">Board number</param>
        ///// <returns>Status of the operation</returns>
        [DllImport("thordaq.dll", EntryPoint = "ThordaqStopAcquisition")]
        ...
        /// <returns>Status of the operation</returns>
        [DllImport("thordaq.dll", EntryPoint = "ThordaqSetImagingConfiguration")]
        public extern static uint SetupPacketGenerator(UInt32 board,
                            ref PACKET_GENCHK_STRUCT PacketGenChk);
        ...
        /// <returns>Status of the operation</returns>
        [DllImport("thordaq.dll", EntryPoint = "ThordaqReadChannel")]
        ...
        /// <param name="Timeout">read timeout</param>
        /// <returns>Status of the operation</returns>
        [DllImport("thordaq.dll", EntryPoint = "ThordaqPacketReadBuffer")]
        ...
        /// <param name="Timeout">read timeout</param>
        /// <returns>Status of the operation</returns>
        [DllImport("thordaq.dll", EntryPoint = "ThordaqPacketWriteBuffer")]
