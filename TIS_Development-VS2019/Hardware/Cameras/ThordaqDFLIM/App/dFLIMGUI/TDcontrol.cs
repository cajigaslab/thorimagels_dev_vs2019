...
using NWLogic.DeviceLib; // Win32 from NWL
...
namespace thordaqGUI
{
    ...
    public class TDcontroller : TDassembly
    {
        ...
        public int TDnType = -1; // e.g. 'n' is 3 for TDQ3, which is TD3 in EEPROM Component field  
...
//    public unsafe struct S2MM_ADCSAMPLE_LUT
  //  {
    ...
    {
        [DllImport("dFLIM_4002.dll", EntryPoint = "ThorDAQAPIsetDACvoltage")]
    ...
    public class S2MM_adcDMA // ThorDAQ's Stream to Mapped Memory Setup and control
    {
        ...
        [DllImport("dFLIM_4002.dll", EntryPoint = "ThorDAQAPIS2MMconfig")]
        public extern static uint ThorDAQAPIS2MMconfig(
                    UInt32 board,                  // Board number to target
                    ref S2MM_CONFIG s2mmConfig);       // size of waveform (must be same for all channels)  
        [DllImport("dFLIM_4002.dll", EntryPoint = "ThorDAQAPIADCsampleImagizerLUT")]
    ...
    {
        [DllImport("dFLIM_4002.dll", EntryPoint = "ThorDAQAPIDACwaveInit")]
        ...
        [DllImport("dFLIM_4002.dll", EntryPoint = "ThorDAQAPIDACwaveLoad")]
    ...
    public class TDmemoryDDR3 // ThorDAQ's on board DRAM,accessible through NWL (AXI) DMA
    {
     ...
     //   [DllImport("dFLIM_4002.dll", EntryPoint = "ThorDAQAPISetupPacketMode")]
  ...
  /*      [DllImport("dFLIM_4002.dll", EntryPoint = "ThorDAQAPIShutdownPacketMode")]
...
//	UINT64  *Value					// "shadow" DLL register copy value (REG or FIELD)
        [DllImport("dFLIM_4002.dll", EntryPoint = "ThorDAQAPIFPGAregisterWrite")]
        ...
        [DllImport("dFLIM_4002.dll", EntryPoint = "ThorDAQAPIFPGAregisterRead")]
        ...
        [DllImport("dFLIM_4002.dll", EntryPoint = "ThorDAQAPIFPGAregisterQuery")]
