...
#define DAC_ANALOG_CHANNEL_COUNT                 12  // ThorDAQ main board design - 12 total analog out channels, plus 1 Digital Out channel not usuable on dFLIM
//
// GPIO Selection
//
...
typedef struct _S2MM_Config
{
	...
	INT32 HSize;
	INT32 VSize;
	INT32 dataHSize;    // dFLIM specific, dependent on pixel WxH and PixelDwell
