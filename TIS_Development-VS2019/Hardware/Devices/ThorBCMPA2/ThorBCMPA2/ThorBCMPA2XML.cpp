...
/// <summary>
/// Initializes a new instance of the <see cref="ThorBCMPA2XML"/> class.
/// </summary>
ThorBCMPA2XML::ThorBCMPA2XML()
{
...
/// <summary>
/// Finalizes an instance of the <see cref="ThorBCMPA2XML"/> class.
/// </summary>
ThorBCMPA2XML::~ThorBCMPA2XML()
{
	if(_xmlObj != NULL)
...
const char * const ThorBCMPA2XML::CONNECTION_ATTR[NUM_CONNECTION_ATTRIBUTES] = {"portID","baudRate","serialNumber","useShutter"};
...
long ThorBCMPA2XML::GetConnection(const string signature, long &portID,long &baudRate, string &serialNumber, long &useShutter)
{	
	OpenConfigFile();
...
/// <param name="portID">The port identifier.</param>
/// <returns>long.</returns>
long ThorBCMPA2XML::SetPortID(const string signature, const long portID)
{
	string str;
	stringstream ss;
...
const char * const ThorBCMPA2XML::TIMEOUT = "TimeOut";

const char * const ThorBCMPA2XML::TIMEOUT_ATTR[NUM_TIMEOUT_ATTRIBUTES] = {"timeMS"};
...
/// <returns>long.</returns>
long ThorBCMPA2XML::GetTimeOut(long &timeOutTime)
{	
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element *configObj = _xmlObj->FirstChildElement(false);
...
/// </summary>
/// <returns>long.</returns>
long ThorBCMPA2XML::OpenConfigFile()
{	
...
/// </summary>
/// <returns>long.</returns>
long ThorBCMPA2XML::SaveConfigFile()
{	
...
/// <returns>long.</returns>
long ThorBCMPA2XML::SetAttribute(string tagName, string attribute, string attributeValue)
{
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element *configObj = _xmlObj->FirstChildElement(false);
