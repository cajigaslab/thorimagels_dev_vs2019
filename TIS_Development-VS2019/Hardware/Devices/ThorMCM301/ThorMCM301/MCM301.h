...
enum CardTypes
{
	...
	MCM_Stepper_LC_HD_DB15,         // 19 42-0129 MCM LC Stepper Module
	MAX_CARD_TYPE,
...
public:
	...
	static Mcm301Params* _mcm301Params;
...
private:
	...
	long RequestSlotTitle();
	long RequestPnpStatus();
	long RequestDeviceSerialNo();
	...
	USHORT _board_type;
	unsigned long _numberOfSetSlots; ///< Number of slots configured in ThorMCM301Settings.xml
	...
	static long _setSlots; ///< Has bits enabled for every slot that was set up in ThorMCM301Settings.xml
