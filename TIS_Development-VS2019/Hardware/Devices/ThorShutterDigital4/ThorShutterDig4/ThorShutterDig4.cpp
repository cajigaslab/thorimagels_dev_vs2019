...
// ThorShutterDig4.cpp : Defines the exported functions for the DLL application.
#include "stdafx.h"
#include "math.h"
...
bool ThorShutterDig4::_deviceDetected = false;

/// <summary>
/// Prevents a default instance of the <see cref="ThorShutterDig4"/> class from being created.
/// </summary>
ThorShutterDig4::ThorShutterDig4()
{	
...
/// <summary>
/// Finalizes an instance of the <see cref="ThorShutterDig4"/> class.
/// </summary>
ThorShutterDig4::~ThorShutterDig4()
{
	_instanceFlag = false;
...
bool ThorShutterDig4:: _instanceFlag = false;

auto_ptr<ThorShutterDig4> ThorShutterDig4::_single(new ThorShutterDig4());

/// <summary>
/// Gets the instance.
/// </summary>
/// <returns>ThorShutterDig4 *.</returns>
ThorShutterDig4 *ThorShutterDig4::getInstance()
{
	if(!_instanceFlag)
	{
		_single.reset(new ThorShutterDig4());
		_instanceFlag = true;
...
long ThorShutterDig4::FindDevices(long &deviceCount)
{
	long	ret = TRUE;

	deviceCount=0;
	//Get filter parameters from hardware setup.xml
	auto_ptr<ThorShutterDig4XML> pSetup(new ThorShutterDig4XML());
	...
	wsprintf(message,L"ThorShutterDig4 FindDevices");
	...
	if (ret=pSetup->OpenConfigFile())
	{
		...
		if(ret=pSetup->GetIO(str,_shutterDelayMS))
		{
			...
			wsprintf(message,L"ThorShutterDig4 Found a device");
			LogMessage(message,VERBOSE_EVENT);
		}
	}
	return ret;
...
/// <returns>long.</returns>
long ThorShutterDig4::SelectDevice(const long device)
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig4::TeardownDevice()
{
...
/// <returns>long.</returns>
long ThorShutterDig4::GetParamInfo
	(
	const long	paramID,
	long		&paramType,
	long		&paramAvailable,
...
/// <returns>long.</returns>
long ThorShutterDig4::SetParam(const long paramID, const double param)
{
	long	ret = TRUE;
...
/// <param name="param">The parameter.</param>
/// <returns>long.</returns>
long ThorShutterDig4::GetParam(const long paramID, double &param)
{
	long	ret = TRUE;
...
/// <returns>long.</returns>
long ThorShutterDig4::SetParamBuffer(const long paramID, char* pBuffer, long size)
{
	long ret = TRUE;
...
/// <param name="size">Buffer size.</param>
/// <returns>long.</returns>
long ThorShutterDig4::GetParamBuffer(const long paramID, char* pBuffer, long size)
{
	long ret = TRUE;
...
/// <returns>long.</returns>
long ThorShutterDig4::SetParamString(const long paramID, wchar_t* str)
{
	long ret = FALSE;
...
/// <param name="size">Buffer size.</param>
/// <returns>long.</returns>
long ThorShutterDig4::GetParamString(const long paramID, wchar_t* str, long size)
{
	long ret = FALSE;
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig4::PreflightPosition()
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig4::SetupPosition()
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig4::StartPosition()
{
	long	ret = FALSE;
	...
	if (0==SetDigital(_shutPos))
	{
		...
		{
			wsprintf(message,L"ThorShutterDig4 sleep on open");
...
/// <returns>long.</returns>
long ThorShutterDig4::StatusPosition(long &status)
{
...
/// <returns>long.</returns>
long ThorShutterDig4::ReadPosition(DeviceType deviceType, double &pos)
{
	long	ret = FALSE;
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig4::PostflightPosition()
{
	return TRUE;
}
...
/// <returns>long.</returns>
long ThorShutterDig4::GetLastErrorMsg(wchar_t * msg, long size)
{	
...
/// <param name="pos">The position.</param>
/// <returns>long.</returns>
long ThorShutterDig4::SetDigital(long pos)
{
	Lock lock(_critSect);

	wsprintf(message,L"ThorShutterDig4 setting digitial %d", pos);
	LogMessage(message,VERBOSE_EVENT);
...
/// </summary>
/// <returns>int.</returns>
int ThorShutterDig4::CloseNITasks()
{
	int32 retVal;
	if (_taskHandleDO0 != 0)
	{
