namespace ThorMTS25Test
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        [DeploymentItem("..\\..\\..\\x64\\Debug\\ThorMTS25.dll", "Modules_Native")]
        [DeploymentItem("..\\..\\..\\ThorMTS25Settings.xml")]
        public void Test_Z_Stage()
        {
            Assert.IsTrue(File.Exists("ThorMTS25Settings.xml"));

            Assert.IsTrue(File.Exists(".\\Modules_Native\\ThorMTS25.dll"));
        ...
        [DllImport(".\\Modules_Native\\ThorMTS25.dll", EntryPoint = "GetParam", CallingConvention = CallingConvention.Cdecl)]
        private static extern int GetParam(int paramID, ref double param);

        [DllImport(".\\Modules_Native\\ThorMTS25.dll", EntryPoint = "GetParamInfo", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(".\\Modules_Native\\ThorMTS25.dll", EntryPoint = "PostflightPosition", CallingConvention = CallingConvention.Cdecl)]
        private static extern int PostflightPosition();

        [DllImport(".\\Modules_Native\\ThorMTS25.dll", EntryPoint = "PreflightPosition", CallingConvention = CallingConvention.Cdecl)]
        private static extern int PreflightPosition();

        [DllImport(".\\Modules_Native\\ThorMTS25.dll", EntryPoint = "SelectDevice", CallingConvention = CallingConvention.Cdecl)]
        private static extern int SelectDevice(int device);

        [DllImport(".\\Modules_Native\\ThorMTS25.dll", EntryPoint = "SetParam", CallingConvention = CallingConvention.Cdecl)]
        private static extern int SetParam(int paramID, double param);

        [DllImport(".\\Modules_Native\\ThorMTS25.dll", EntryPoint = "SetupPosition", CallingConvention = CallingConvention.Cdecl)]
        private static extern int SetupPosition();

        [DllImport(".\\Modules_Native\\ThorMTS25.dll", EntryPoint = "StartPosition", CallingConvention = CallingConvention.Cdecl)]
        private static extern int StartPosition();

        [DllImport(".\\Modules_Native\\ThorMTS25.dll", EntryPoint = "StatusPosition", CallingConvention = CallingConvention.Cdecl)]
        private static extern int StatusPosition(ref int status);

        [DllImport(".\\Modules_Native\\ThorMTS25.dll", EntryPoint = "TeardownDevice", CallingConvention = CallingConvention.Cdecl)]
