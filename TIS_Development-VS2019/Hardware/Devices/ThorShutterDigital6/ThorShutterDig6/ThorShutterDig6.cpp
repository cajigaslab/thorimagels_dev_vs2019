...
// ThorShutterDig6.cpp : Defines the exported functions for the DLL application.
#include "stdafx.h"
#include "math.h"
#include "ThorShutterDig6.h"
#include "ThorShutterDig6SetupXML.h"

/// <summary>
/// The message
/// </summary>
wchar_t message[MAX_PATH];
bool ThorShutterDig6::_deviceDetected = false;

/// <summary>
/// Prevents a default instance of the <see cref="ThorShutterDig6"/> class from being created.
/// </summary>
ThorShutterDig6::ThorShutterDig6()
{	
...
/// <summary>
/// Finalizes an instance of the <see cref="ThorShutterDig6"/> class.
/// </summary>
ThorShutterDig6::~ThorShutterDig6()
{
	_instanceFlag = false;
...
bool ThorShutterDig6:: _instanceFlag = false;

auto_ptr<ThorShutterDig6> ThorShutterDig6::_single(new ThorShutterDig6());

/// <summary>
/// Gets the instance.
/// </summary>
/// <returns>ThorShutterDig6 *.</returns>
ThorShutterDig6 *ThorShutterDig6::getInstance()
{
	if(!_instanceFlag)
	{
		_single.reset(new ThorShutterDig6());
		_instanceFlag = true;
...
long ThorShutterDig6::FindDevices(long &deviceCount)
{
	long	ret = TRUE;

	deviceCount=0;
	//Get filter parameters from hardware setup.xml
	auto_ptr<ThorShutterDig6XML> pSetup(new ThorShutterDig6XML());
	...
	wsprintf(message,L"ThorShutterDig6 FindDevices");
	...
	if (ret=pSetup->OpenConfigFile())
	{
		...
		if(ret=pSetup->GetIO(str,_shutterDelayMS))
		{
			...
			wsprintf(message,L"ThorShutterDig6 Found a device");
			LogMessage(message,VERBOSE_EVENT);
		}
	}
	return ret;
...
/// <returns>long.</returns>
long ThorShutterDig6::SelectDevice(const long device)
{
	return TRUE;
}
...
/// <returns>long.</returns>
long ThorShutterDig6::GetParamInfo
	(
	const long	paramID,
	long		&paramType,
	long		&paramAvailable,
...
/// <returns>long.</returns>
long ThorShutterDig6::SetParam(const long paramID, const double param)
{
	long	ret = TRUE;
...
/// <param name="param">The parameter.</param>
/// <returns>long.</returns>
long ThorShutterDig6::GetParam(const long paramID, double &param)
{
	long	ret = TRUE;
...
/// <returns>long.</returns>
long ThorShutterDig6::SetParamBuffer(const long paramID, char* pBuffer, long size)
{
	long ret = TRUE;
...
/// <param name="size">Buffer size.</param>
/// <returns>long.</returns>
long ThorShutterDig6::GetParamBuffer(const long paramID, char* pBuffer, long size)
{
	long ret = TRUE;
...
/// <returns>long.</returns>
long ThorShutterDig6::SetParamString(const long paramID, wchar_t* str)
{
	long ret = FALSE;
...
/// <param name="size">Buffer size.</param>
/// <returns>long.</returns>
long ThorShutterDig6::GetParamString(const long paramID, wchar_t* str, long size)
{
	long ret = FALSE;
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig6::PreflightPosition()
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig6::SetupPosition()
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig6::StartPosition()
{
	long	ret = FALSE;
	...
	if (0==SetDigital(_shutPos))
	{
		...
		{
			wsprintf(message,L"ThorShutterDig6 sleep on open");
...
/// <returns>long.</returns>
long ThorShutterDig6::StatusPosition(long &status)
{
...
/// <returns>long.</returns>
long ThorShutterDig6::ReadPosition(DeviceType deviceType, double &pos)
{
	long	ret = FALSE;
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig6::PostflightPosition()
{
	return TRUE;
}
...
/// <returns>long.</returns>
long ThorShutterDig6::GetLastErrorMsg(wchar_t * msg, long size)
{	
...
/// <param name="pos">The position.</param>
/// <returns>long.</returns>
long ThorShutterDig6::SetDigital(long pos)
{
	Lock lock(_critSect);

	wsprintf(message,L"ThorShutterDig6 setting digitial %d", pos);
	LogMessage(message,VERBOSE_EVENT);
...
/// </summary>
/// <returns>int.</returns>
int ThorShutterDig6::CloseNITasks()
{
	int32 retVal;
	if (_taskHandleDO0 != 0)
	{
