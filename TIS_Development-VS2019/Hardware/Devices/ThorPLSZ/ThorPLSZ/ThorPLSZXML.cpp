...
/// <summary>
/// Initializes a new instance of the <see cref="ThorPLSZXML"/> class.
/// </summary>
ThorPLSZXML::ThorPLSZXML()
{
	_xmlObj = NULL;
	_currentPathAndFile;
}
...
/// <summary>
/// Finalizes an instance of the <see cref="ThorPLSZXML"/> class.
/// </summary>
ThorPLSZXML::~ThorPLSZXML()
{
	if(_xmlObj != NULL)
...
const char * const ThorPLSZXML::CONNECTION = "Connection";

const char * const ThorPLSZXML::CONNECTION_ATTR[NUM_CONNECTION_ATTRIBUTES] = {"portID","baudRate","address"};
...
long ThorPLSZXML::GetConnection(long &portID,long &baudRate, long &address)
{	
	OpenConfigFile();
...
const char * const ThorPLSZXML::ZRANGECONFIG = "ZRangeConfig";

const char * const ThorPLSZXML::ZRANGECONFIG_ATTR[NUM_ZRANGECONFIG_ATTRIBUTES] = {"minMM","maxMM", "threshold", "invert","home"};
...
/// <returns>long.</returns>
long ThorPLSZXML::GetZRangeConfig(double &minMM, double &maxMM, double &threshold, bool &invert, bool &home)
{	
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element *configObj = _xmlObj->FirstChildElement(false);
...
const char * const ThorPLSZXML::SLEEPAFTERMOVE = "SleepAfterMove";

const char * const ThorPLSZXML::SLEEPAFTERMOVE_ATTR[NUM_SLEEPAFTERMOVE_ATTRIBUTES] = {"time_milliseconds"};
...
/// <returns>long.</returns>
long ThorPLSZXML::GetSleepAfterMove(long &time_milliseconds)
{	
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element *configObj = _xmlObj->FirstChildElement(false);
...
/// </summary>
/// <returns>long.</returns>
long ThorPLSZXML::OpenConfigFile()
{	
	wsprintf(_currentPathAndFile,L"ThorPLSZSettings.xml");		
...
/// </summary>
/// <returns>long.</returns>
long ThorPLSZXML::SaveConfigFile()
{	
