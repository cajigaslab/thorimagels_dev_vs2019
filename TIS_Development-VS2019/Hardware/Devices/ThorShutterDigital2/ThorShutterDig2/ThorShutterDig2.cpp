...
// ThorShutterDig2.cpp : Defines the exported functions for the DLL application.
#include "stdafx.h"
#include "math.h"
#include "ThorShutterDig2.h"
...
bool ThorShutterDig2::_deviceDetected = false;

/// <summary>
/// Prevents a default instance of the <see cref="ThorShutterDig2"/> class from being created.
/// </summary>
ThorShutterDig2::ThorShutterDig2()
{	
...
/// <summary>
/// Finalizes an instance of the <see cref="ThorShutterDig2"/> class.
/// </summary>
ThorShutterDig2::~ThorShutterDig2()
{
	_instanceFlag = false;
...
bool ThorShutterDig2:: _instanceFlag = false;

auto_ptr<ThorShutterDig2> ThorShutterDig2::_single(new ThorShutterDig2());

/// <summary>
/// Gets the instance.
/// </summary>
/// <returns>ThorShutterDig2 *.</returns>
ThorShutterDig2 *ThorShutterDig2::getInstance()
{
	if(!_instanceFlag)
	{
		_single.reset(new ThorShutterDig2());
		_instanceFlag = true;
...
long ThorShutterDig2::FindDevices(long &deviceCount)
{
	long	ret = TRUE;

	deviceCount=0;
	//Get filter parameters from hardware setup.xml
	auto_ptr<ThorShutterDig2XML> pSetup(new ThorShutterDig2XML());
	...
	wsprintf(message,L"ThorShutterDig2 FindDevices");
	...
	if (ret=pSetup->OpenConfigFile())
	{
		...
		if(ret=pSetup->GetIO(str,_shutterDelayMS))
		{
			...
			wsprintf(message,L"ThorShutterDig2 Found a device");
			LogMessage(message,VERBOSE_EVENT);
		}
	}
	return ret;
...
/// <returns>long.</returns>
long ThorShutterDig2::SelectDevice(const long device)
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig2::TeardownDevice()
{
	CloseNITasks();
	return TRUE;
}
...
/// <returns>long.</returns>
long ThorShutterDig2::GetParamInfo
	(
	const long	paramID,
	long		&paramType,
	long		&paramAvailable,
...
/// <returns>long.</returns>
long ThorShutterDig2::SetParam(const long paramID, const double param)
{
	long	ret = TRUE;
...
/// <param name="param">The parameter.</param>
/// <returns>long.</returns>
long ThorShutterDig2::GetParam(const long paramID, double &param)
{
	long	ret = TRUE;
...
/// <returns>long.</returns>
long ThorShutterDig2::SetParamBuffer(const long paramID, char* pBuffer, long size)
{
	long ret = TRUE;
...
/// <param name="size">Buffer size.</param>
/// <returns>long.</returns>
long ThorShutterDig2::GetParamBuffer(const long paramID, char* pBuffer, long size)
{
	long ret = TRUE;
...
/// <returns>long.</returns>
long ThorShutterDig2::SetParamString(const long paramID, wchar_t* str)
{
	long ret = FALSE;
...
/// <param name="size">Buffer size.</param>
/// <returns>long.</returns>
long ThorShutterDig2::GetParamString(const long paramID, wchar_t* str, long size)
{
	long ret = FALSE;
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig2::PreflightPosition()
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig2::SetupPosition()
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig2::StartPosition()
{
	long	ret = FALSE;
	...
	if (0==SetDigital(_shutPos))
	{
		...
		{
			wsprintf(message,L"ThorShutterDig2 sleep on open");
...
/// <returns>long.</returns>
long ThorShutterDig2::StatusPosition(long &status)
{
...
/// <returns>long.</returns>
long ThorShutterDig2::ReadPosition(DeviceType deviceType, double &pos)
{
	long	ret = FALSE;
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig2::PostflightPosition()
{
	return TRUE;
}
...
/// <returns>long.</returns>
long ThorShutterDig2::GetLastErrorMsg(wchar_t * msg, long size)
{	
...
/// <param name="pos">The position.</param>
/// <returns>long.</returns>
long ThorShutterDig2::SetDigital(long pos)
{
	Lock lock(_critSect);

	wsprintf(message,L"ThorShutterDig2 setting digitial %d", pos);
	LogMessage(message,VERBOSE_EVENT);
...
/// </summary>
/// <returns>int.</returns>
int ThorShutterDig2::CloseNITasks()
{
	int32 retVal;
	if (_taskHandleDO0 != 0)
	{
