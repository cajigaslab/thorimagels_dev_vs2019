...
// ThorShutterDig3.cpp : Defines the exported functions for the DLL application.
#include "stdafx.h"
#include "math.h"
#include "ThorShutterDig3.h"
#include "ThorShutterDig3SetupXML.h"

/// <summary>
/// The message
/// </summary>
wchar_t message[MAX_PATH];
bool ThorShutterDig3::_deviceDetected = false;

/// <summary>
/// Prevents a default instance of the <see cref="ThorShutterDig3"/> class from being created.
/// </summary>
ThorShutterDig3::ThorShutterDig3()
{	
...
/// <summary>
/// Finalizes an instance of the <see cref="ThorShutterDig3"/> class.
/// </summary>
ThorShutterDig3::~ThorShutterDig3()
{
	_instanceFlag = false;
...
bool ThorShutterDig3:: _instanceFlag = false;

auto_ptr<ThorShutterDig3> ThorShutterDig3::_single(new ThorShutterDig3());

/// <summary>
/// Gets the instance.
/// </summary>
/// <returns>ThorShutterDig3 *.</returns>
ThorShutterDig3 *ThorShutterDig3::getInstance()
{
	if(!_instanceFlag)
	{
		_single.reset(new ThorShutterDig3());
		_instanceFlag = true;
...
long ThorShutterDig3::FindDevices(long &deviceCount)
{
	long	ret = TRUE;

	deviceCount=0;
	//Get filter parameters from hardware setup.xml
	auto_ptr<ThorShutterDig3XML> pSetup(new ThorShutterDig3XML());
	...
	wsprintf(message,L"ThorShutterDig3 FindDevices");
	...
	if (ret=pSetup->OpenConfigFile())
	{
		...
		if(ret=pSetup->GetIO(str,_shutterDelayMS))
		{
			...
			wsprintf(message,L"ThorShutterDig3 Found a device");
			LogMessage(message,VERBOSE_EVENT);
		}
	}
	return ret;
...
/// <returns>long.</returns>
long ThorShutterDig3::SelectDevice(const long device)
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig3::TeardownDevice()
{
...
/// <returns>long.</returns>
long ThorShutterDig3::GetParamInfo
	(
	const long	paramID,
	long		&paramType,
	long		&paramAvailable,
...
/// <returns>long.</returns>
long ThorShutterDig3::SetParam(const long paramID, const double param)
{
	long	ret = TRUE;
...
/// <param name="param">The parameter.</param>
/// <returns>long.</returns>
long ThorShutterDig3::GetParam(const long paramID, double &param)
{
	long	ret = TRUE;
...
/// <returns>long.</returns>
long ThorShutterDig3::SetParamBuffer(const long paramID, char* pBuffer, long size)
{
	long ret = TRUE;
...
/// <param name="size">Buffer size.</param>
/// <returns>long.</returns>
long ThorShutterDig3::GetParamBuffer(const long paramID, char* pBuffer, long size)
{
	long ret = TRUE;
...
/// <returns>long.</returns>
long ThorShutterDig3::SetParamString(const long paramID, wchar_t* str)
{
	long ret = FALSE;
...
/// <param name="size">Buffer size.</param>
/// <returns>long.</returns>
long ThorShutterDig3::GetParamString(const long paramID, wchar_t* str, long size)
{
	long ret = FALSE;
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig3::PreflightPosition()
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig3::SetupPosition()
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig3::StartPosition()
{
	long	ret = FALSE;
	...
	if (0==SetDigital(_shutPos))
	{
		...
		{
			wsprintf(message,L"ThorShutterDig3 sleep on open");
...
/// <returns>long.</returns>
long ThorShutterDig3::StatusPosition(long &status)
{
...
/// <returns>long.</returns>
long ThorShutterDig3::ReadPosition(DeviceType deviceType, double &pos)
{
	long	ret = FALSE;
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig3::PostflightPosition()
{
	return TRUE;
}
...
/// <returns>long.</returns>
long ThorShutterDig3::GetLastErrorMsg(wchar_t * msg, long size)
{	
...
/// <param name="pos">The position.</param>
/// <returns>long.</returns>
long ThorShutterDig3::SetDigital(long pos)
{
	Lock lock(_critSect);

	wsprintf(message,L"ThorShutterDig3 setting digitial %d", pos);
	LogMessage(message,VERBOSE_EVENT);
