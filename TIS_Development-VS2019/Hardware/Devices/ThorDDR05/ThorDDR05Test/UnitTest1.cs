...
namespace ThorDDR05Test
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        [DeploymentItem("..\\..\\..\\x64\\Debug\\ThorDDR05.dll", "Modules_Native")]
        [DeploymentItem("..\\..\\..\\ThorDDR05Settings.xml")]
        public void Test_DDR05_GG()
        {
            Assert.IsTrue(File.Exists("ThorDDR05Settings.xml"));
            Assert.IsTrue(File.Exists(".\\Modules_Native\\ThorDDR05.dll"));
            int deviceCount = 0;
        ...
        [DllImport(".\\Modules_Native\\ThorDDR05.dll", EntryPoint = "GetParam", CallingConvention = CallingConvention.Cdecl)]
        private static extern int GetParam(int paramID, ref double param);

        [DllImport(".\\Modules_Native\\ThorDDR05.dll", EntryPoint = "GetParamInfo", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(".\\Modules_Native\\ThorDDR05.dll", EntryPoint = "TeardownDevice", CallingConvention = CallingConvention.Cdecl)]
        private static extern int TeardownDevice();

        [DllImport(".\\Modules_Native\\ThorDDR05.dll", EntryPoint = "SelectDevice", CallingConvention = CallingConvention.Cdecl)]
        private static extern int SelectDevice(int device);

        [DllImport(".\\Modules_Native\\ThorDDR05.dll", EntryPoint = "FindDevices", CallingConvention = CallingConvention.Cdecl)]
        private static extern int FindDevices(ref int deviceCount);

        [DllImport(".\\Modules_Native\\ThorDDR05.dll", EntryPoint = "SetParam", CallingConvention = CallingConvention.Cdecl)]
        private static extern int SetParam(int paramID, double param);

        [DllImport(".\\Modules_Native\\ThorDDR05.dll", EntryPoint = "StartPosition", CallingConvention = CallingConvention.Cdecl)]
