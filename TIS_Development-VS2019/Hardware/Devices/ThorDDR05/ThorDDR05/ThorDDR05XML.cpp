...
const char * const ThorDDR05XML::CONNECTION_ATTR[NUM_CONNECTION_ATTRIBUTES] = {"portID","baudRate","serialNumber","useShutter"};
...
long ThorDDR05XML::GetConnection(const string signature, long &portID,long &baudRate, string &serialNumber, long &useShutter)
{	
	OpenConfigFile();
...
/// <param name="portID">The port identifier.</param>
/// <returns>long.</returns>
long ThorDDR05XML::SetPortID(const string signature, const long portID)
{
	string str;
	stringstream ss;
...
const char * const ThorDDR05XML::TIMEOUT = "TimeOut";

const char * const ThorDDR05XML::TIMEOUT_ATTR[NUM_TIMEOUT_ATTRIBUTES] = {"timeMS"};
...
/// <returns>long.</returns>
long ThorDDR05XML::GetTimeOut(long &timeOutTime)
{	
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element *configObj = _xmlObj->FirstChildElement(false);
...
/// </summary>
/// <returns>long.</returns>
long ThorDDR05XML::OpenConfigFile()
{	
	wsprintf(_currentPathAndFile,L"ThorDDR05Settings.xml");		
...
/// </summary>
/// <returns>long.</returns>
long ThorDDR05XML::SaveConfigFile()
{	
...
/// <returns>long.</returns>
long ThorDDR05XML::SetAttribute(string tagName, string attribute, string attributeValue)
{
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element *configObj = _xmlObj->FirstChildElement(false);
