...
/// <summary>
/// Initializes a new instance of the <see cref="ThorMCM3000AuxXML"/> class.
/// </summary>
ThorMCM3000AuxXML::ThorMCM3000AuxXML()
{
	_xmlObj = NULL;
...
/// <summary>
/// Finalizes an instance of the <see cref="ThorMCM3000AuxXML"/> class.
/// </summary>
ThorMCM3000AuxXML::~ThorMCM3000AuxXML()
{
	if(_xmlObj != NULL)
...
const char * const ThorMCM3000AuxXML::CONNECTION = "Connection";

const char * const ThorMCM3000AuxXML::CONNECTION_ATTR[NUM_CONNECTION_ATTRIBUTES] = {"portID","baudRate","address"};
...
long ThorMCM3000AuxXML::GetConnection(long &portID,long &baudRate, long &address)
{	
	OpenConfigFile();
...
const char * const ThorMCM3000AuxXML::STAGEAXISCONFIG = "StageAxisConfig";

const char * const ThorMCM3000AuxXML::STAGEAXISCONFIG_ATTR[NUM_STAGEAXISCONFIG_ATTRIBUTES] = {"Stage1","Stage2","Stage3"};
...
/// <returns>long.</returns>
long ThorMCM3000AuxXML::GetXYZStageAxes(long &axis0,long &axis1, long &axis2)
{	
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element *configObj = _xmlObj->FirstChildElement(false);
...
const char * const ThorMCM3000AuxXML::XRANGECONFIG = "XRangeConfig";

const char * const ThorMCM3000AuxXML::XRANGECONFIG_ATTR[NUM_XRANGECONFIG_ATTRIBUTES] = {"minMM","maxMM", "threshold", "invert"};
...
/// <returns>long.</returns>
long ThorMCM3000AuxXML::GetXRangeConfig(double &minMM, double &maxMM, double &threshold, bool &invert)
{	
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element *configObj = _xmlObj->FirstChildElement(false);
...
const char * const ThorMCM3000AuxXML::YRANGECONFIG = "YRangeConfig";

const char * const ThorMCM3000AuxXML::YRANGECONFIG_ATTR[NUM_YRANGECONFIG_ATTRIBUTES] = {"minMM","maxMM", "threshold", "invert"};
...
/// <param name="threshold">The threshold.</param>
/// <returns>long.</returns>
long ThorMCM3000AuxXML::GetYRangeConfig(double &minMM, double &maxMM, double &threshold, bool &invert)
{	
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element *configObj = _xmlObj->FirstChildElement(false);
...
const char * const ThorMCM3000AuxXML::ZRANGECONFIG = "ZRangeConfig";

const char * const ThorMCM3000AuxXML::ZRANGECONFIG_ATTR[NUM_ZRANGECONFIG_ATTRIBUTES] = {"minMM","maxMM", "threshold", "invert"};
...
/// <param name="threshold">The threshold.</param>
/// <returns>long.</returns>
long ThorMCM3000AuxXML::GetZRangeConfig(double &minMM, double &maxMM, double &threshold, bool &invert)
{	
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element *configObj = _xmlObj->FirstChildElement(false);
...
const char * const ThorMCM3000AuxXML::SLEEPAFTERMOVE = "SleepAfterMove";

const char * const ThorMCM3000AuxXML::SLEEPAFTERMOVE_ATTR[NUM_SLEEPAFTERMOVE_ATTRIBUTES] = {"time_milliseconds"};
...
/// <returns>long.</returns>
long ThorMCM3000AuxXML::GetSleepAfterMove(long &time_milliseconds)
{	
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element *configObj = _xmlObj->FirstChildElement(false);
...
/// </summary>
/// <returns>long.</returns>
long ThorMCM3000AuxXML::OpenConfigFile()
{	
	wsprintf(_currentPathAndFile,L"ThorMCM3000AuxSettings.xml");		
...
/// </summary>
/// <returns>long.</returns>
long ThorMCM3000AuxXML::SaveConfigFile()
{	
