...
// ThorShutterDig.cpp : Defines the exported functions for the DLL application.
#include "stdafx.h"
#include "math.h"
...
bool ThorShutterDig::_deviceDetected = false;

/// <summary>
/// Prevents a default instance of the <see cref="ThorShutterDig"/> class from being created.
/// </summary>
ThorShutterDig::ThorShutterDig()
{	
...
/// <summary>
/// Finalizes an instance of the <see cref="ThorShutterDig"/> class.
/// </summary>
ThorShutterDig::~ThorShutterDig()
{
	_instanceFlag = false;
...
bool ThorShutterDig:: _instanceFlag = false;

auto_ptr<ThorShutterDig> ThorShutterDig::_single(new ThorShutterDig());

/// <summary>
/// Gets the instance.
/// </summary>
/// <returns>ThorShutterDig *.</returns>
ThorShutterDig *ThorShutterDig::getInstance()
{
	if(!_instanceFlag)
	{
		_single.reset(new ThorShutterDig());
		_instanceFlag = true;
...
long ThorShutterDig::FindDevices(long &deviceCount)
{
	long	ret = TRUE;

	deviceCount=0;
	//Get filter parameters from hardware setup.xml
	auto_ptr<ThorShutterDigXML> pSetup(new ThorShutterDigXML());
	...
	wsprintf(message,L"ThorShutterDig FindDevices");
	...
	if (ret=pSetup->OpenConfigFile())
	{
		...
		if(ret=pSetup->GetIO(str,_shutterDelayMS))
		{
			...
			wsprintf(message,L"ThorShutterDig Found a device");
			LogMessage(message,VERBOSE_EVENT);
		}
	}
	return ret;
...
/// <returns>long.</returns>
long ThorShutterDig::SelectDevice(const long device)
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig::TeardownDevice()
{
	CloseNITasks();
	return TRUE;
}
...
/// <returns>long.</returns>
long ThorShutterDig::GetParamInfo
	(
	const long	paramID,
	long		&paramType,
	long		&paramAvailable,
...
/// <returns>long.</returns>
long ThorShutterDig::SetParam(const long paramID, const double param)
{
	long	ret = TRUE;
...
/// <param name="param">The parameter.</param>
/// <returns>long.</returns>
long ThorShutterDig::GetParam(const long paramID, double &param)
{
	long	ret = TRUE;
...
/// <returns>long.</returns>
long ThorShutterDig::SetParamBuffer(const long paramID, char* pBuffer, long size)
{
	long ret = TRUE;
...
/// <param name="size">Buffer size.</param>
/// <returns>long.</returns>
long ThorShutterDig::GetParamBuffer(const long paramID, char* pBuffer, long size)
{
	long ret = TRUE;
...
/// <returns>long.</returns>
long ThorShutterDig::SetParamString(const long paramID, wchar_t* str)
{
	long ret = FALSE;
...
/// <param name="size">Buffer size.</param>
/// <returns>long.</returns>
long ThorShutterDig::GetParamString(const long paramID, wchar_t* str, long size)
{
	long ret = FALSE;
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig::PreflightPosition()
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig::SetupPosition()
{
	return TRUE;
}
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig::StartPosition()
{
	long	ret = FALSE;
	...
	if (0==SetDigital(_shutPos))
	{
		...
		{
			wsprintf(message,L"ThorShutterDig sleep on open");
...
/// <returns>long.</returns>
long ThorShutterDig::StatusPosition(long &status)
{
...
/// <returns>long.</returns>
long ThorShutterDig::ReadPosition(DeviceType deviceType, double &pos)
{
	long	ret = FALSE;
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig::PostflightPosition()
{
	return TRUE;
}
...
/// <returns>long.</returns>
long ThorShutterDig::GetLastErrorMsg(wchar_t * msg, long size)
{	
...
/// <param name="pos">The position.</param>
/// <returns>long.</returns>
long ThorShutterDig::SetDigital(long pos)
{
	Lock lock(_critSect);

	wsprintf(message,L"ThorShutterDig setting digitial %d", pos);
	LogMessage(message,VERBOSE_EVENT);
...
/// </summary>
/// <returns>int.</returns>
int ThorShutterDig::CloseNITasks()
{
	int32 retVal;
	if (_taskHandleDO0 != 0)
	{
