...
/// </summary>
ThorShutterDig5XML::ThorShutterDig5XML()
{
	_xmlObj = NULL;
	_currentPathAndFile;
}
...
const char * const ThorShutterDig5XML::IO = "IO";

const char * const ThorShutterDig5XML::IO_ATTR[NUM_IO_ATTRIBUTES] = {"shutterLine","shutterDelayMS"};
...
long ThorShutterDig5XML::GetIO(string &shutterLine, long &shutterDelayMS)
{
	try
	{
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig5XML::OpenConfigFile()
{	
	if(_xmlObj != NULL)
	{
		delete _xmlObj;
	...
	wsprintf(_currentPathAndFile,L"ThorShutterDig5Settings.xml");		
...
/// </summary>
/// <returns>long.</returns>
long ThorShutterDig5XML::SaveConfigFile()
{	
	if(_xmlObj != NULL)
	{
		wsprintf(_currentPathAndFile,L"ThorShutterDig5Settings.xml");		
