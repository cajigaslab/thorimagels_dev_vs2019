...
ParamInfo::ParamInfo( long pID, long pVal,long p_C,BOOL p_B,
					 long typ,long avail,long readOnly, long pMin,long pMax,
					 long pDefault,std::vector<unsigned char> command)
{
	_paramID = pID;
	_paramVal = pVal;
	_param_C = p_C;
...
/// </summary>
/// <returns>double.</returns>
long ParamInfo::GetParamCurrent()
{
	return _param_C;
}
...
long ParamInfo::SetParamVal(long val)
{
	_paramVal = val;
