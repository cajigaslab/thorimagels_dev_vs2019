...
/// </summary>
ThorMCM6000_CondenserXML::ThorMCM6000_CondenserXML()
{
...
const char* const ThorMCM6000_CondenserXML::CONNECTION = "Connection";
const char* const ThorMCM6000_CondenserXML::CONNECTION_ATTR[NUM_CONNECTION_ATTRIBUTES] = { "portID", "baudRate", "serialNumber" };
/// <summary>
/// Gets the connection.
/// </summary>
...
long ThorMCM6000_CondenserXML::GetConnection(long& portID, long& baudRate, string& serialNumber)
{
	OpenConfigFile();
...
/// <param name="portID">The port identifier.</param>
/// <returns>long.</returns>
long ThorMCM6000_CondenserXML::SetPortID(const string signature, const long portID)
{
	string str;
	stringstream ss;
...
const char* const ThorMCM6000_CondenserXML::TIMEOUT = "TimeOut";
const char* const ThorMCM6000_CondenserXML::TIMEOUT_ATTR[NUM_TIMEOUT_ATTRIBUTES] = { "timeMS" };
/// <summary>
/// Gets the time out.
/// </summary>
/// <param name="timeOutTime">The max time out to wait for the device to reach position.</param>
/// <returns>long.</returns>
long ThorMCM6000_CondenserXML::GetTimeOut(long& timeOutTime)
{
	OpenConfigFile();
	// make sure the top level root element exist
	ticpp::Element* configObj = _xmlObj->FirstChildElement(false);
...
/// </summary>
/// <returns>long.</returns>
long ThorMCM6000_CondenserXML::OpenConfigFile()
{
	wsprintf(_currentPathAndFile, L"ThorMCM6000_CondenserSettings.xml");
...
/// </summary>
/// <returns>long.</returns>
long ThorMCM6000_CondenserXML::SaveConfigFile()
{
...
/// <returns>long.</returns>
long ThorMCM6000_CondenserXML::SetAttribute(string tagName, string attribute, string attributeValue)
{
	long ret = FALSE;
	OpenConfigFile();
	// make sure the top level root element exist
