...
namespace ThorLightPathSimulatorTest
{
    using System;
    using System.IO;
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        [DeploymentItem("..\\..\\..\\x64\\Debug\\ThorLightPathSimulator.dll", "Modules_Native")]
        public void Test_BCM_GG()
        {
            Assert.IsTrue(File.Exists(".\\Modules_Native\\ThorLightPathSimulator.dll"));
            int deviceCount = 0;
        ...
        [DllImport(".\\Modules_Native\\ThorLightPathSimulator.dll", EntryPoint = "GetParam", CallingConvention = CallingConvention.Cdecl)]
        private static extern int GetParam(int paramID, ref double param);

        [DllImport(".\\Modules_Native\\ThorLightPathSimulator.dll", EntryPoint = "GetParamInfo", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(".\\Modules_Native\\ThorLightPathSimulator.dll", EntryPoint = "TeardownDevice", CallingConvention = CallingConvention.Cdecl)]
        private static extern int TeardownDevice();

        [DllImport(".\\Modules_Native\\ThorLightPathSimulator.dll", EntryPoint = "SelectDevice", CallingConvention = CallingConvention.Cdecl)]
        private static extern int SelectDevice(int device);

        [DllImport(".\\Modules_Native\\ThorLightPathSimulator.dll", EntryPoint = "FindDevices", CallingConvention = CallingConvention.Cdecl)]
        private static extern int FindDevices(ref int deviceCount);

        [DllImport(".\\Modules_Native\\ThorLightPathSimulator.dll", EntryPoint = "SetParam", CallingConvention = CallingConvention.Cdecl)]
        private static extern int SetParam(int paramID, double param);

        [DllImport(".\\Modules_Native\\ThorLightPathSimulator.dll", EntryPoint = "StartPosition", CallingConvention = CallingConvention.Cdecl)]
